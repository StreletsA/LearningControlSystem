...
function get_all_persons(){
    ...
    request.open('GET', api_address + "persons/");
...
function delete_person(evt){
    ...
    request.open('GET', api_address + "persons/delete?personal_number=" + evt.target.id);
...
function search_persons(event){
    ...
    request.open('GET', api_address + "persons/search" + req);
